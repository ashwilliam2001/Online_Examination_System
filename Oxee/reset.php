...
<body style="margin:0;height: 100%;outline: none;color: #7e7e7e !important;">
    <div class="bg" style="font-weight: bolder;background-image: url(./images/background.png);background-repeat: no-repeat;padding: 0;margin: 0;background-size: cover;font-family: 'Courier New', Courier, monospace;opacity: 0.9;height: auto;padding-bottom: 5vw;">
        <center>
...
if (isset($_POST['submit'])) {
    if (isset($_POST['email1']) && isset($_POST['pass1']) && isset($_POST['cpass1'])) {
        ...
        $cpassword = crypt($cpassword, 'akashbiswas');
