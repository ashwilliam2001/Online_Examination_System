...
<body style="margin: 0 !important;font-weight: bolder !important;font-family: 'Courier New', Courier, monospace;color:#fff !important">
    <div style="background-color: #7e7e7e;height: 100%;">
        <div class="navbar" style="display: inline-flex;width: 100%;color:#7e7e7e;position:fixed;">
            <section style="margin: 1.5vw;">ONLINE EXAMINATION management SYSTEM</section>
            ...
            <section id="ans">
                <center>
                    <form style="margin: 0vw;width: 100vw" method="post">
                        ...
                        <input type="submit" name="submit" value="add 1 more question" style="height: 3vw;width:max-content;font-family: 'Courier New', Courier, monospace;font-weight: bolder;border-radius: 10px;border: 2px solid black;background-color: lightblue;">
...
//session_unset();
//session_destroy();
echo "window.location.replace(\"http://localhost/DBMSproject3/DBMS-MINI-project3/index.php\");" .
    "}" .
    "function addquiz(){" .
