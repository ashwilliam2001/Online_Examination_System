...
if (isset($_POST['studsu'])) {
    ...
    if (isset($_POST['name1']) && isset($_POST['usn1']) && isset($_POST['mail1']) && isset($_POST['phno1']) && isset($_POST['dept1']) && isset($_POST['dob1']) && isset($_POST['gender1']) && isset($_POST['password1']) && isset($_POST['cpassword1'])) {
        ...
        $password1 = crypt($password1,'arghya');
        $cpassword1 = crypt($cpassword1,'arghya');
...
if (isset($_POST['staffsu'])) {
    ...
    if (isset($_POST['name2']) && isset($_POST['staffid']) && isset($_POST['mail2']) && isset($_POST['phno2']) && isset($_POST['dept2']) && isset($_POST['dob2']) && isset($_POST['gender2']) && isset($_POST['password2']) && isset($_POST['cpassword2'])) {
        ...
        $password2 = crypt($password2,'akashbiswas');
        $cpassword2 = crypt( $cpassword2,'akashbiswas');
...
<body style="margin: 0;padding: 0;outline: none;height: 100%;min-height: 100vw;color: #7e7e7e !important">
    <div style="font-family: 'Courier New', Courier, monospace;margin: 0;padding: 0;background-color: #fff;height: 100%;width: 100%;padding-bottom: 5vw;background-color:chocolate;height: 100% !important;">
        <center>
